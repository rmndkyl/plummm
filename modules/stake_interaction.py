...
def stake_tokens(private_key, token_address):
    ...
    # Round the balance to the nearest whole number of tokens
    ...
    # Data for Calling the stake Function of the Implementation Contract
